                ...
                "items": [
                    {
                        ...
                        "reorder_point": round(float(r.reorder_point), 1) if r.reorder_point is not None else None,
                        "safety_stock": round(float(r.safety_stock_units), 1) if r.safety_stock_units is not None else None,
        ...
        try:
            ...
            if suggestion:
                result["suggestion"] = {
                    ...
                    "reorder_point": round(float(suggestion.reorder_point), 1) if suggestion.reorder_point is not None else None,
                    "safety_stock": round(float(suggestion.safety_stock_units), 1) if suggestion.safety_stock_units is not None else None,
                    "lead_time_demand": round(float(suggestion.lead_time_demand), 1) if suggestion.lead_time_demand is not None else None,
                    "seasonality_factor": round(float(suggestion.seasonality_factor), 2) if suggestion.seasonality_factor is not None else None,
